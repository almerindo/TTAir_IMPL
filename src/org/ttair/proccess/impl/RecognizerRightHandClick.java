...
public class RecognizerRightHandClick extends ARecognizerKinectHandPoint{


	private static final long serialVersionUID = -4219132837276910607L;

	public RecognizerRightHandClick() {
		this.setJointType(JointType.RIGHT_HAND);
		this.setJointTypeReference(JointType.RIGHT_ELBOW);
		this.setJointTypeReference2(JointType.RIGHT_SHOULDER);
